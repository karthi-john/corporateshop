...
SET WORKSPACE=%USERPROFILE%\corporateshop\workspace
...
SET ORG_GRADLE_PROJECT_buildEnvironmentPropertiesSample=%USERPROFILE%\corporateshop\environment.properties.sample
